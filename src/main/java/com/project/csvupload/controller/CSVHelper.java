...
public class CSVHelper {
	...
	/**
	 * @param file
	 * @return true if the file has CSV format
	 */
	...
	/**
	 * @param inputStream
	 * @return list of students which has been read from csv file
	 */
	public static List<Student> csvToList(InputStream inputStream) {
		try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(inputStream, "UTF-8"));
			...
			for (CSVRecord csvRecord : csvRecords) {
				Student developerTutorial = new Student(Integer.parseInt(csvRecord.get(0)), csvRecord.get(1),
